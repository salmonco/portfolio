import { SIDE_PROJECT_DETAILED } from "./side-projects";
import { STARTUP_PROJECT } from "./startup-projects";

const MAIN_PROJECTS_LIMIT = 3;

// 스타트업 + 사이드 프로젝트 합쳐서 최대 3개
const allProjects = [...STARTUP_PROJECT, ...SIDE_PROJECT_DETAILED];
...
export const HOME_DATA = {
  ...
  mainProjects: allProjects.slice(0, MAIN_PROJECTS_LIMIT).map((project) => ({
    id: project.id,
    title: project.title,
